...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of mpu_data_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins mpu_data_0/S00_AXI]
	connect_bd_net [get_bd_pins mpu_data_0/s00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins mpu_data_0/s00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins mpu_data_0/S01_AXI]
	connect_bd_net [get_bd_pins mpu_data_0/s01_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins mpu_data_0/s01_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M02_AXI] [get_bd_intf_pins mpu_data_0/S02_AXI]
	connect_bd_net [get_bd_pins mpu_data_0/s02_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins mpu_data_0/s02_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M03_AXI] [get_bd_intf_pins mpu_data_0/S03_AXI]
	connect_bd_net [get_bd_pins mpu_data_0/s03_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins mpu_data_0/s03_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M04_AXI] [get_bd_intf_pins mpu_data_0/S04_AXI]
	connect_bd_net [get_bd_pins mpu_data_0/s04_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins mpu_data_0/s04_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M05_AXI] [get_bd_intf_pins mpu_data_0/S05_AXI]
	connect_bd_net [get_bd_pins mpu_data_0/s05_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins mpu_data_0/s05_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to mpu_data_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/mpu_data_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_mpu_data_0_S00_AXI_* ]]
	puts $fp "set s00_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_mpu_data_0_S01_AXI_* ]]
	puts $fp "set s01_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_mpu_data_0_S02_AXI_* ]]
	puts $fp "set s02_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_mpu_data_0_S03_AXI_* ]]
	puts $fp "set s03_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_mpu_data_0_S04_AXI_* ]]
	puts $fp "set s04_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_mpu_data_0_S05_AXI_* ]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:mpu_data:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/mpu_data_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "mpu_data_v1_0_hw_${i}"
